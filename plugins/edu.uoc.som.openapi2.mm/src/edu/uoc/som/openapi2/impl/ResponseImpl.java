 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi2.impl.ResponseImpl#getCode <em>Code</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.ResponseImpl#getResponseDefinition <em>Response Definition</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.ResponseImpl#getDefault <em>Default</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponseImpl extends ResponseDeclaringContextImpl implements Response {
	/**
	...
	public ResponseDefinition getResponseDefinition() {
		if (responseDefinition != null && responseDefinition.eIsProxy()) {
			...
			if (responseDefinition != oldResponseDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OpenAPIPackage.RESPONSE__RESPONSE_DEFINITION, oldResponseDefinition, responseDefinition));
			}
		}
	...
	public void setResponseDefinition(ResponseDefinition newResponseDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenAPIPackage.RESPONSE__RESPONSE_DEFINITION, oldResponseDefinition, responseDefinition));
	}
	...
	public void setDefault(Boolean newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenAPIPackage.RESPONSE__DEFAULT, oldDefault, default_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenAPIPackage.RESPONSE__CODE:
				return getCode();
			case OpenAPIPackage.RESPONSE__RESPONSE_DEFINITION:
				if (resolve) return getResponseDefinition();
				return basicGetResponseDefinition();
			case OpenAPIPackage.RESPONSE__DEFAULT:
				return getDefault();
		}
