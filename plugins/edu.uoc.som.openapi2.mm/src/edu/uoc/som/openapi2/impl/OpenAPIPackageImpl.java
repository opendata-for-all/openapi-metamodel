...
import edu.uoc.som.openapi2.ArrayContext;
...
import edu.uoc.som.openapi2.ExternalDocsContext;
...
import edu.uoc.som.openapi2.ParameterContext;
import edu.uoc.som.openapi2.ParameterDeclaringContext;
...
import edu.uoc.som.openapi2.SchemaDeclaringContext;
import edu.uoc.som.openapi2.SchemeType;
import edu.uoc.som.openapi2.SecurityContext;
...
import edu.uoc.som.openapi2.util.OpenAPIValidator;
...
public class OpenAPIPackageImpl extends EPackageImpl implements OpenAPIPackage {
	 ...
	 * @see edu.uoc.som.openapi2.OpenAPIPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		responseDefinitionEClass.getESuperTypes().add(this.getSchemaDeclaringContext());
		responseDefinitionEClass.getESuperTypes().add(this.getSchemaContext());
		responseDefinitionEClass.getESuperTypes().add(this.getReferenceableElement());
		...
		propertyEClass.getESuperTypes().add(this.getSchemaDeclaringContext());
		responseEClass.getESuperTypes().add(this.getResponseDeclaringContext());
		...
		initEReference(getRoot_Responses(), this.getResponseDefinition(), null, "responses", null, 0, -1, Root.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(apiEClass, edu.uoc.som.openapi2.API.class, "API", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAPI_Swagger(), ecorePackage.getEString(), "swagger", null, 0, 1, edu.uoc.som.openapi2.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAPI_Definitions(), this.getSchema(), null, "definitions", null, 0, -1, edu.uoc.som.openapi2.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAPI_Responses(), this.getResponseDefinition(), null, "responses", null, 0, -1, edu.uoc.som.openapi2.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAPI_SecurityDefinitions(), this.getSecurityScheme(), null, "securityDefinitions", null, 0, -1, edu.uoc.som.openapi2.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getResponseDefinition_DeclaringContext(), this.getResponseDeclaringContext(), null, "declaringContext", null, 0, 1, ResponseDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
