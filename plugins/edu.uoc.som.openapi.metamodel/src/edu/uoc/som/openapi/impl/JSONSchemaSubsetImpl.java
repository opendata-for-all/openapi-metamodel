 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getUniqueItems <em>Unique Items</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getEnum <em>Enum</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.JSONSchemaSubsetImpl#getMultipleOf <em>Multiple Of</em>}</li>
 * </ul>
 *
 * @generated
 */
