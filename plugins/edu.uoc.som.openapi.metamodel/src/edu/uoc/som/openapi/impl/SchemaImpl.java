 ...
 *   <li>{@link edu.uoc.som.openapi.impl.SchemaImpl#getExample <em>Example</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.SchemaImpl#getDiscriminator <em>Discriminator</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.SchemaImpl#getReadOnly <em>Read Only</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.SchemaImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.SchemaImpl#getAllOf <em>All Of</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.SchemaImpl#getItems <em>Items</em>}</li>
