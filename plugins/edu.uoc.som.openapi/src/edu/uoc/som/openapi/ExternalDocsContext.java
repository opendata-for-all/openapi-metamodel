 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi.ExternalDocsContext#getExternalDocs <em>External Docs</em>}</li>
 * </ul>
 *
 * @see edu.uoc.som.openapi.OpenAPIPackage#getExternalDocsContext()
 * @model abstract="true"
 * @generated
 */
public interface ExternalDocsContext extends EObject {
	 ...
	 * @see edu.uoc.som.openapi.OpenAPIPackage#getExternalDocsContext_ExternalDocs()
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.openapi.ExternalDocsContext#getExternalDocs <em>External Docs</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
