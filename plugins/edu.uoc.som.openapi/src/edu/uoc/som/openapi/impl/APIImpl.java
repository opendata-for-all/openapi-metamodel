 ...
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getInfo <em>Info</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getHost <em>Host</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getBasePath <em>Base Path</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getSchemes <em>Schemes</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getConsumes <em>Consumes</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getProduces <em>Produces</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getPaths <em>Paths</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getDefinitions <em>Definitions</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getResponses <em>Responses</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getSecurityDefinitions <em>Security Definitions</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.APIImpl#getTags <em>Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
