 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link edu.uoc.som.openapi.impl.ParameterImpl#getUniqueItems <em>Unique Items</em>}</li>
...
public class ParameterImpl extends SchemaDeclaringContextImpl implements Parameter {
	...
	public void setExample(String newExample) {
		...
		example = newExample;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenAPIPackage.PARAMETER__EXAMPLE, oldExample, example));
	}
