 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeImpl#getFlow <em>Flow</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeImpl#getAuthorizationUrl <em>Authorization Url</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeImpl#getTokenUrl <em>Token Url</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeImpl#getScopes <em>Scopes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecuritySchemeImpl extends MinimalEObjectImpl.Container implements SecurityScheme {
	...
	protected EClass eStaticClass() {
		return Openapi3Package.Literals.SECURITY_SCHEME;
	}
	...
	public void setType(SecuritySchemeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_SCHEME__TYPE, oldType, type));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_SCHEME__DESCRIPTION, oldDescription, description));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_SCHEME__NAME, oldName, name));
	}
	...
	public void setLocation(APIKeyLocation newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_SCHEME__LOCATION, oldLocation, location));
	}
	...
	public void setFlow(OAuth2FlowType newFlow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_SCHEME__FLOW, oldFlow, flow));
	}
	...
	public void setAuthorizationUrl(String newAuthorizationUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_SCHEME__AUTHORIZATION_URL, oldAuthorizationUrl, authorizationUrl));
	}
	...
	public void setTokenUrl(String newTokenUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_SCHEME__TOKEN_URL, oldTokenUrl, tokenUrl));
	}
	...
	public EList<SecurityScope> getScopes() {
		if (scopes == null) {
			scopes = new EObjectContainmentEList<SecurityScope>(SecurityScope.class, this, Openapi3Package.SECURITY_SCHEME__SCOPES);
		}
		return scopes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Openapi3Package.SECURITY_SCHEME__SCOPES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Openapi3Package.SECURITY_SCHEME__TYPE:
				return getType();
			case Openapi3Package.SECURITY_SCHEME__DESCRIPTION:
				return getDescription();
			case Openapi3Package.SECURITY_SCHEME__NAME:
				return getName();
			case Openapi3Package.SECURITY_SCHEME__LOCATION:
				return getLocation();
			case Openapi3Package.SECURITY_SCHEME__FLOW:
				return getFlow();
			case Openapi3Package.SECURITY_SCHEME__AUTHORIZATION_URL:
				return getAuthorizationUrl();
			case Openapi3Package.SECURITY_SCHEME__TOKEN_URL:
				return getTokenUrl();
			case Openapi3Package.SECURITY_SCHEME__SCOPES:
				return getScopes();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Openapi3Package.SECURITY_SCHEME___GET_SECURITY_SCOPE_BY_NAME__STRING:
