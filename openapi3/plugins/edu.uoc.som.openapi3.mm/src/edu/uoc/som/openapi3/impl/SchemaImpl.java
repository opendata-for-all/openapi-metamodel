 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getExternalDocs <em>External Docs</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getMaxProperties <em>Max Properties</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getMinProperties <em>Min Properties</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getExample <em>Example</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getDiscriminator <em>Discriminator</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getReadOnly <em>Read Only</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getAllOf <em>All Of</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getItems <em>Items</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getXml <em>Xml</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getAdditonalProperties <em>Additonal Properties</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getDeclaringContext <em>Declaring Context</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SchemaImpl#getAdditonalPropertiesAllowed <em>Additonal Properties Allowed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchemaImpl extends JSONSchemaSubsetImpl implements Schema {
	...
	protected EClass eStaticClass() {
		return Openapi3Package.Literals.SCHEMA;
	}
	...
	public NotificationChain basicSetExternalDocs(ExternalDocs newExternalDocs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__EXTERNAL_DOCS, oldExternalDocs, newExternalDocs);
	...
	public void setExternalDocs(ExternalDocs newExternalDocs) {
		if (newExternalDocs != externalDocs) {
			...
			if (externalDocs != null)
				msgs = ((InternalEObject)externalDocs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Openapi3Package.SCHEMA__EXTERNAL_DOCS, null, msgs);
			if (newExternalDocs != null)
				msgs = ((InternalEObject)newExternalDocs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Openapi3Package.SCHEMA__EXTERNAL_DOCS, null, msgs);
			msgs = basicSetExternalDocs(newExternalDocs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__EXTERNAL_DOCS, newExternalDocs, newExternalDocs));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__TITLE, oldTitle, title));
	}
	...
	public void setMaxProperties(Integer newMaxProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__MAX_PROPERTIES, oldMaxProperties, maxProperties));
	}
	...
	public void setMinProperties(Integer newMinProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__MIN_PROPERTIES, oldMinProperties, minProperties));
	}
	...
	public void setExample(String newExample) {
		...
		example = newExample;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__EXAMPLE, oldExample, example));
	}
	...
	public void setDiscriminator(String newDiscriminator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__DISCRIMINATOR, oldDiscriminator, discriminator));
	}
	...
	public void setReadOnly(Boolean newReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__READ_ONLY, oldReadOnly, readOnly));
	}
	...
	public EList<Property> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<Property>(Property.class, this, Openapi3Package.SCHEMA__PROPERTIES);
		}
		return properties;
	}
	...
	public EList<Schema> getAllOf() {
		if (allOf == null) {
			allOf = new EObjectResolvingEList<Schema>(Schema.class, this, Openapi3Package.SCHEMA__ALL_OF);
		}
		return allOf;
	}
	...
	public Schema getItems() {
		if (items != null && items.eIsProxy()) {
			...
			if (items != oldItems) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Openapi3Package.SCHEMA__ITEMS, oldItems, items));
			}
		}
		return items;
	}
	...
	public void setItems(Schema newItems) {
		...
		items = newItems;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__ITEMS, oldItems, items));
	}
	...
	public NotificationChain basicSetXml(XMLElement newXml, NotificationChain msgs) {
		...
		xml = newXml;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__XML, oldXml, newXml);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXml(XMLElement newXml) {
		if (newXml != xml) {
			NotificationChain msgs = null;
			if (xml != null)
				msgs = ((InternalEObject)xml).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Openapi3Package.SCHEMA__XML, null, msgs);
			if (newXml != null)
				msgs = ((InternalEObject)newXml).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Openapi3Package.SCHEMA__XML, null, msgs);
			msgs = basicSetXml(newXml, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__XML, newXml, newXml));
	}
	...
	public Schema getAdditonalProperties() {
		if (additonalProperties != null && additonalProperties.eIsProxy()) {
			...
			if (additonalProperties != oldAdditonalProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Openapi3Package.SCHEMA__ADDITONAL_PROPERTIES, oldAdditonalProperties, additonalProperties));
			}
		}
	...
	public void setAdditonalProperties(Schema newAdditonalProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__ADDITONAL_PROPERTIES, oldAdditonalProperties, additonalProperties));
	}
	...
	public SchemaContainer getDeclaringContext() {
		if (declaringContext != null && declaringContext.eIsProxy()) {
			...
			if (declaringContext != oldDeclaringContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Openapi3Package.SCHEMA__DECLARING_CONTEXT, oldDeclaringContext, declaringContext));
			}
		}
	...
	public void setDeclaringContext(SchemaContainer newDeclaringContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__DECLARING_CONTEXT, oldDeclaringContext, declaringContext));
	}
	...
	public void setAdditonalPropertiesAllowed(Boolean newAdditonalPropertiesAllowed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SCHEMA__ADDITONAL_PROPERTIES_ALLOWED, oldAdditonalPropertiesAllowed, additonalPropertiesAllowed));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Openapi3Package.SCHEMA__EXTERNAL_DOCS:
				return basicSetExternalDocs(null, msgs);
			case Openapi3Package.SCHEMA__PROPERTIES:
				return ((InternalEList<?>)getProperties()).basicRemove(otherEnd, msgs);
			case Openapi3Package.SCHEMA__XML:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Openapi3Package.SCHEMA__TITLE:
				return getTitle();
			case Openapi3Package.SCHEMA__MAX_PROPERTIES:
				return getMaxProperties();
			case Openapi3Package.SCHEMA__MIN_PROPERTIES:
				return getMinProperties();
			case Openapi3Package.SCHEMA__EXAMPLE:
				return getExample();
			case Openapi3Package.SCHEMA__DISCRIMINATOR:
				return getDiscriminator();
			case Openapi3Package.SCHEMA__READ_ONLY:
				return getReadOnly();
			case Openapi3Package.SCHEMA__PROPERTIES:
				return getProperties();
			case Openapi3Package.SCHEMA__ALL_OF:
				return getAllOf();
			case Openapi3Package.SCHEMA__ITEMS:
				if (resolve) return getItems();
				return basicGetItems();
			case Openapi3Package.SCHEMA__XML:
				return getXml();
			case Openapi3Package.SCHEMA__ADDITONAL_PROPERTIES:
				if (resolve) return getAdditonalProperties();
				return basicGetAdditonalProperties();
			case Openapi3Package.SCHEMA__DECLARING_CONTEXT:
				if (resolve) return getDeclaringContext();
				return basicGetDeclaringContext();
			case Openapi3Package.SCHEMA__ADDITONAL_PROPERTIES_ALLOWED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ExternalDocsContext.class) {
			switch (derivedFeatureID) {
				case Openapi3Package.SCHEMA__EXTERNAL_DOCS: return Openapi3Package.EXTERNAL_DOCS_CONTEXT__EXTERNAL_DOCS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ExternalDocsContext.class) {
			switch (baseFeatureID) {
				case Openapi3Package.EXTERNAL_DOCS_CONTEXT__EXTERNAL_DOCS: return Openapi3Package.SCHEMA__EXTERNAL_DOCS;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Openapi3Package.SCHEMA___GET_PROPERTY_BY_NAME__STRING:
