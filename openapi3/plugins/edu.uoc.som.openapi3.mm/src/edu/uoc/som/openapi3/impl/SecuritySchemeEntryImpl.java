 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecuritySchemeEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecuritySchemeEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,SecurityScheme> {
	...
	protected EClass eStaticClass() {
		return Openapi3Package.Literals.SECURITY_SCHEME_ENTRY;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_SCHEME_ENTRY__KEY, oldKey, key));
	}
	...
	public SecurityScheme getTypedValue() {
		if (value != null && value.eIsProxy()) {
			...
			value = (SecurityScheme)eResolveProxy(oldValue);
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Openapi3Package.SECURITY_SCHEME_ENTRY__VALUE, oldValue, value));
			}
		}
		return value;
	}
	 ...
	 * @generated
	 */
	public SecurityScheme basicGetTypedValue() {
		return value;
	}
	...
	public void setTypedValue(SecurityScheme newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_SCHEME_ENTRY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Openapi3Package.SECURITY_SCHEME_ENTRY__KEY:
				return getTypedKey();
			case Openapi3Package.SECURITY_SCHEME_ENTRY__VALUE:
