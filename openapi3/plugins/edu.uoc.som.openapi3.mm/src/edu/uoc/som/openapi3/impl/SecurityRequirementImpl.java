 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecurityRequirementImpl#getSecurityScopes <em>Security Scopes</em>}</li>
 *   <li>{@link edu.uoc.som.openapi3.impl.SecurityRequirementImpl#getSecurityScheme <em>Security Scheme</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecurityRequirementImpl extends MinimalEObjectImpl.Container implements SecurityRequirement {
	...
	protected EClass eStaticClass() {
		return Openapi3Package.Literals.SECURITY_REQUIREMENT;
	}
	...
	public EList<SecurityScope> getSecurityScopes() {
		if (securityScopes == null) {
			securityScopes = new EObjectResolvingEList<SecurityScope>(SecurityScope.class, this, Openapi3Package.SECURITY_REQUIREMENT__SECURITY_SCOPES);
		}
		...
		if (securityScheme != null && securityScheme.eIsProxy()) {
			...
			if (securityScheme != oldSecurityScheme) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Openapi3Package.SECURITY_REQUIREMENT__SECURITY_SCHEME, oldSecurityScheme, securityScheme));
			}
		}
	...
	public void setSecurityScheme(SecurityScheme newSecurityScheme) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Openapi3Package.SECURITY_REQUIREMENT__SECURITY_SCHEME, oldSecurityScheme, securityScheme));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Openapi3Package.SECURITY_REQUIREMENT__SECURITY_SCOPES:
				return getSecurityScopes();
			case Openapi3Package.SECURITY_REQUIREMENT__SECURITY_SCHEME:
