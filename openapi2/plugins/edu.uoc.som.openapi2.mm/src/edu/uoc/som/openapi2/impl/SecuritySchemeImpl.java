 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi2.impl.SecuritySchemeImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.SecuritySchemeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.SecuritySchemeImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.SecuritySchemeImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.SecuritySchemeImpl#getFlow <em>Flow</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.SecuritySchemeImpl#getAuthorizationUrl <em>Authorization Url</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.SecuritySchemeImpl#getTokenUrl <em>Token Url</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.SecuritySchemeImpl#getScopes <em>Scopes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecuritySchemeImpl extends ReferenceableElementImpl implements SecurityScheme {
	/**
