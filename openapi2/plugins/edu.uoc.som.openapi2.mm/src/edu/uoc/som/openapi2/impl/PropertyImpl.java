 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi2.impl.PropertyImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PropertyImpl#getRequired <em>Required</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyImpl extends ReferenceableElementImpl implements Property {
		...
		if (schema != null && schema.eIsProxy()) {
			...
			if (schema != oldSchema) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OpenAPIPackage.PROPERTY__SCHEMA, oldSchema, schema));
			}
		}
		return schema;
	}
	...
	public void setSchema(Schema newSchema) {
		...
		schema = newSchema;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenAPIPackage.PROPERTY__SCHEMA, oldSchema, schema));
	}
