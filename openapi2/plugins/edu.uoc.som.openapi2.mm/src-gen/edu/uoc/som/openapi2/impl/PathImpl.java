 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getRelativePath <em>Relative Path</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getGet <em>Get</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getPut <em>Put</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getPost <em>Post</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getDelete <em>Delete</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getHead <em>Head</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getPatch <em>Patch</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getApi <em>Api</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.impl.PathImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PathImpl extends ParameterContainerImpl implements Path {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case OpenAPI2Package.PATH___GET_OPERATION_BY_HTTP_METHOD__STRING:
