 ...
 * </p>
 * <ul>
 *   <li>{@link flow.impl.PropertyImpl#getRequest <em>Request</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
	...
	protected EClass eStaticClass() {
		return FlowPackage.Literals.PROPERTY;
	}
		...
		if (request != null && request.eIsProxy()) {
			...
			if (request != oldRequest) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FlowPackage.PROPERTY__REQUEST, oldRequest, request));
			}
		}
		return request;
	}
	...
	public void setRequest(Request newRequest) {
		...
		request = newRequest;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.PROPERTY__REQUEST, oldRequest, request));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FlowPackage.PROPERTY__REQUEST:
