...
public class FlowSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FlowPackage.SEQUENCE: {
				Sequence sequence = (Sequence)theEObject;
				T result = caseSequence(sequence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowPackage.STEP: {
				Step step = (Step)theEObject;
				T result = caseStep(step);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowPackage.REQUEST: {
			...
			case FlowPackage.PROPERTY_TRANSFER: {
			...
			case FlowPackage.INPUT_PROPERTY: {
			...
			case FlowPackage.OUTPUT_PROPERTY: {
			...
			case FlowPackage.HEADER_PROPERTY: {
			...
			case FlowPackage.RESPONSE_PROPERTY: {
			...
			case FlowPackage.PARAMETER_PROPERTY: {
