...
import edu.uoc.som.openapi2.flow.Flow;
import edu.uoc.som.openapi2.flow.HeaderProperty;
import edu.uoc.som.openapi2.flow.InputProperty;
import edu.uoc.som.openapi2.flow.OpenAPI2FlowFactory;
import edu.uoc.som.openapi2.flow.OpenAPI2FlowPackage;
import edu.uoc.som.openapi2.flow.OutputProperty;
...
import edu.uoc.som.openapi2.flow.ResponseProperty;
import edu.uoc.som.openapi2.flow.Sequence;
 ...
 * @generated
 */
public class OpenAPI2FlowPackageImpl extends EPackageImpl implements OpenAPI2FlowPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see edu.uoc.som.openapi2.flow.OpenAPI2FlowPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OpenAPI2FlowPackageImpl() {
		super(eNS_URI, OpenAPI2FlowFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link OpenAPI2FlowPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static OpenAPI2FlowPackage init() {
		if (isInited) return (OpenAPI2FlowPackage)EPackage.Registry.INSTANCE.getEPackage(OpenAPI2FlowPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredOpenAPI2FlowPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		OpenAPI2FlowPackageImpl theOpenAPI2FlowPackage = registeredOpenAPI2FlowPackage instanceof OpenAPI2FlowPackageImpl ? (OpenAPI2FlowPackageImpl)registeredOpenAPI2FlowPackage : new OpenAPI2FlowPackageImpl();
		...
		theOpenAPI2FlowPackage.createPackageContents();

		// Initialize created meta-data
		theOpenAPI2FlowPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theOpenAPI2FlowPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(OpenAPI2FlowPackage.eNS_URI, theOpenAPI2FlowPackage);
		return theOpenAPI2FlowPackage;
	}
	 ...
	 */
	@Override
	public OpenAPI2FlowFactory getOpenAPI2FlowFactory() {
		return (OpenAPI2FlowFactory)getEFactoryInstance();
	}
