 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi2.mapping.impl.PropertyToParameterImpl#getSource <em>Source</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.mapping.impl.PropertyToParameterImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyToParameterImpl extends MinimalEObjectImpl.Container implements PropertyToParameter {
	...
	protected EClass eStaticClass() {
		return OpenAPI2MappingPackage.Literals.PROPERTY_TO_PARAMETER;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OpenAPI2MappingPackage.PROPERTY_TO_PARAMETER__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Property newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenAPI2MappingPackage.PROPERTY_TO_PARAMETER__SOURCE, oldSource, source));
	}
	...
	public Parameter getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OpenAPI2MappingPackage.PROPERTY_TO_PARAMETER__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Parameter newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenAPI2MappingPackage.PROPERTY_TO_PARAMETER__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenAPI2MappingPackage.PROPERTY_TO_PARAMETER__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case OpenAPI2MappingPackage.PROPERTY_TO_PARAMETER__TARGET:
