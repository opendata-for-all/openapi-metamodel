 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi2.flow.impl.ResponsePropertyImpl#getSchemaProperty <em>Schema Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponsePropertyImpl extends OutputPropertyImpl implements ResponseProperty {
	...
	protected EClass eStaticClass() {
		return OpenAPI2FlowPackage.Literals.RESPONSE_PROPERTY;
	}
		...
		if (schemaProperty != null && schemaProperty.eIsProxy()) {
			...
			if (schemaProperty != oldSchemaProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OpenAPI2FlowPackage.RESPONSE_PROPERTY__SCHEMA_PROPERTY, oldSchemaProperty, schemaProperty));
			}
		}
	...
	public void setSchemaProperty(Property newSchemaProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenAPI2FlowPackage.RESPONSE_PROPERTY__SCHEMA_PROPERTY, oldSchemaProperty, schemaProperty));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenAPI2FlowPackage.RESPONSE_PROPERTY__SCHEMA_PROPERTY:
