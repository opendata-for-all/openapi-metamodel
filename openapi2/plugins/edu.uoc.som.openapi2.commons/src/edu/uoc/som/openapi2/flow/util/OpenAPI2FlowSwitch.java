 ...
 * @generated
 */
public class OpenAPI2FlowSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OpenAPI2FlowPackage.SEQUENCE: {
				Sequence sequence = (Sequence)theEObject;
				T result = caseSequence(sequence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenAPI2FlowPackage.STEP: {
				Step step = (Step)theEObject;
				T result = caseStep(step);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenAPI2FlowPackage.REQUEST: {
				Request request = (Request)theEObject;
				T result = caseRequest(request);
				if (result == null) result = caseStep(request);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenAPI2FlowPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenAPI2FlowPackage.PROPERTY_TRANSFER: {
				PropertyTransfer propertyTransfer = (PropertyTransfer)theEObject;
				T result = casePropertyTransfer(propertyTransfer);
				if (result == null) result = caseStep(propertyTransfer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpenAPI2FlowPackage.INPUT_PROPERTY: {
			...
			case OpenAPI2FlowPackage.OUTPUT_PROPERTY: {
			...
			case OpenAPI2FlowPackage.HEADER_PROPERTY: {
			...
			case OpenAPI2FlowPackage.RESPONSE_PROPERTY: {
			...
			case OpenAPI2FlowPackage.PARAMETER_PROPERTY: {
